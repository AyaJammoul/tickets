<?php
ob_start();
//In page all ticket we get the  name of the branch that we want to make for it report. When we take the name of the branch from this page we go to the table to check the tickets that we have that are connected to this branch
...
if ($branchId) {
    ...
    $branch = new Branch();
    $ticket = new Ticket();
    $branchDetails = $branch->find($branchId);
    // Fetch the tickets for this branch
    $branchTickets = $ticket->getTicketsBybranch($branchId);
    ...
    <body>
        ...
        <div class="report">
            <h2>All Tickets for Branch: <?php echo htmlspecialchars($branchDetails->name); ?></h2>
            <table class="ticket-details">
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="10">No tickets found for this branch.</td>
                    </tr>
                <?php endif; ?>
                </tbody>
            </table>
...
document.addEventListener("DOMContentLoaded", function () {
    const generatePDF = () => {
        ...
        // Add a title
        doc.setFontSize(18);
        doc.text( "All Tickets for Branch: <?php echo htmlspecialchars($branchDetails->name); ?>", 105, 20, { align: "center" });
        
        doc.setFontSize(12);
        doc.text("ID User: <?php echo htmlspecialchars($branchDetails->id); ?>", 105, 30, { align: "center" });
        ...
        doc.save("<?php echo htmlspecialchars($branchDetails->name); ?>");
    };
