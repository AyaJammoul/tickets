...
if (isset($_SESSION['user_id']) && isset($_SESSION['user_role'])) {
        if ($_SESSION['user_role'] === 'manager') {
             $tickets = TicketManager::findAll($branchId,$userId);  
        }
    } else {
...
if (isset($_GET['del'])) {
    ...
    try {
        $ticket->delete($id);
        echo '<script>alert("Ticket deleted successfully");window.location = "./all-ticket-manager"</script>';
    } catch (Exception $e) {
        echo $e->getMessage();
    }
}
                                    ...
                                    <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                        <div class="btn-group" role="group">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                <a href="./edit-ticket-of-manager?id=<?php echo $ticket->id ?>" class="dropdown-item">View</a>
