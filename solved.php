...
$branchId = $_SESSION['branch_id'];  
    ...
    if (isset($user->role) && $user->role === 'admin') {
        $tickets = Ticket::findByStatus('solved',$branchId);
    } else {
        $tickets = Ticket::findByStatusAndUser('solved', $user->id);
    }
                        ...
                        <tbody>
                            ...
                            <tr>
                               <td><?php echo $ticket->id?></a></td>
                                ...
                                <td>
                                <?php 
                                $user = User::find($ticket->team_member); // Assuming User::find() returns a User object
                                echo $user && isset($user->name) ? $user->name : "N/A";
                                ?>
                                </td>
